    ...
    <form id="addReport">
      ...
      >
        ...
        <div
          ...
          <button
            ...
            v-if="form.operationalFailed">
              Er is iets misgegaan bij het toevoegen aan de database
            </small>
            <small
            v-if="form.operationalSucceeded">
              Het verslag is toegevoegd
            </small>
        </section>
        <section
          v-if="step == 'Workforce'">
          <h3>Personeel</h3>
            ...
            <div
              ...
              <small
              v-if="form.workForceFailed">
                Er is iets misgegaan bij het toevoegen aan de database
              </small>
              <small
                v-if="form.WorkForceSucceeded">
                Het verslag is toegevoegd
             </small>
        </section>
        ...
        v-if="step == 'Technical'">
          ...
          class="row">
            <div
            class="checkbox-container text-sm-left col-lg-3" >
            <div
            class="text-sm-left">
              <div
              class="text-sm-left">
                  ...
                  <div
                    ...
                    <div
                      ...
                      class="text-sm-left"
                      type="checkbox"
                      name="Verwittiging anderen">
                      <label>
                        Verwittiging anderen
                      </label>
                    </div>
                  </div>
              </div>
