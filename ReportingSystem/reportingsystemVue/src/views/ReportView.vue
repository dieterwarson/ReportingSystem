...
<div class="container pt-5 pb-5" v-if="!(Object.keys(reportContent).length === 0)">
      ...
      <div class="card w-100">
        ...
        <div class="card-body">
          ...
          <div v-else class="row row-cols-1">
            ...
            <div v-for="event in notificationContent.administrative.workplaceEvents" :key="event.id">
              <div class="col card h-100">
                <div class="card-body">
                  <h3 class="card-title display-5">
                    {{ new Date(event.date).toLocaleString("nl-BE", {
            ...
            <div v-for="event in notificationContent.administrative.secretariatNotifications" :key="event.id">
              <div class="col card h-100">
                <div class="card-body">
                  <h3 class="card-title display-5">
                    {{ new Date(event.date).toLocaleString("nl-BE", {
  ...
  <section v-if="step == 'Workforce'" class="container">
    <div v-if="(Object.keys(reportContent.administrative.workplaceEvents).length === 0) && (Object.keys(reportContent.administrative.secretariatNotifications).length === 0)">
      <p>Er zijn nog geen gebeurtenissen van deze categorie</p>
    </div>
    <div v-else class="row row-cols-1 row-cols-md-2">
  ...
  <section v-if="step == 'Technical'" class="container">
    <div v-if="(Object.keys(reportContent.technical.defects).length === 0) && (Object.keys(reportContent.technical.malfunctions).length === 0)">
      <p>Er zijn nog geen gebeurtenissen van deze categorie</p>
    </div>
    <div v-else class="row row-cols-1 row-cols-md-2">
