        ...
        <div class="card w-100">
          ...
          <div class="card-body">
            ...
            <div v-else class="row row-cols-1">
              <div v-for="event in monitored.administrative.workplaceEvents" :key="event.id">
                <div class="col">
              ...
              <div v-for="event in monitored.administrative
      ...
      <div class="col">
        <div class="card w-100">
          ...
          <div class="card-body">
            ...
            <div v-else class="row row-cols-1">
              <div v-for="event in monitored.technical.defects" :key="event.id">
                <div class="col">
                  <div class="card h-100 mb-3">
              ...
              <div v-for="event in monitored.technical.malfunctions" :key="event.id">
                <div class="col">
                  <div class="card h-100 mb-3">
